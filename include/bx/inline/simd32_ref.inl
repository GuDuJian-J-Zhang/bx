...
namespace bx
{
	...
	BX_CONSTEXPR_FUNC simd32_t simd32_u32_xorl(simd32_t _a, simd32_t _b)
	{
		return { uint32_t(!_a.u32 != !_b.u32) };
	}

	BX_CONSTEXPR_FUNC simd32_t simd32_x32_rol(simd32_t _a, int _count)
	{
		return { (_a.u32 << _count) | (_a.u32 >> (32 - _count)) };
	}

	BX_CONSTEXPR_FUNC simd32_t simd32_x32_ror(simd32_t _a, int _count)
	{
		return { (_a.u32 >> _count) | (_a.u32 << (32 - _count)) };
	}

	BX_CONSTEXPR_FUNC simd32_t simd32_u32_setnz(simd32_t _a)
	{
		return { uint32_t(-!!_a.u32) };
	}

	BX_CONSTEXPR_FUNC simd32_t simd32_u32_satadd(simd32_t _a, simd32_t _b)
	{
		const uint32_t add = _a.u32 + _b.u32;
		return { add | -(add < _a.u32) };
	}

	BX_CONSTEXPR_FUNC simd32_t simd32_u32_satsub(simd32_t _a, simd32_t _b)
	{
		const uint32_t sub = _a.u32 - _b.u32;
		return { sub & -(sub <= _a.u32) };
	}

	BX_CONSTEXPR_FUNC simd32_t simd32_u32_satmul(simd32_t _a, simd32_t _b)
	{
	...
	BX_CONSTEXPR_FUNC simd32_t simd32_u32_incwrap(simd32_t _val, simd32_t _min, simd32_t _max)
	{
	...
	BX_CONSTEXPR_FUNC simd32_t simd32_u32_decwrap(simd32_t _val, simd32_t _min, simd32_t _max)
	{
	...
	BX_CONSTEXPR_FUNC simd32_t simd32_x32_cntbits(simd32_t _a)
	{
		simd32_t result;
	...
	BX_CONSTEXPR_FUNC simd32_t simd32_x32_cntlz(simd32_t _a)
	{
		simd32_t result;
#if BX_COMPILER_GCC || BX_COMPILER_CLANG
	...
	BX_CONSTEXPR_FUNC simd32_t simd32_x32_cnttz(simd32_t _a)
	{
		simd32_t result;
#if BX_COMPILER_GCC || BX_COMPILER_CLANG
	...
	BX_CONSTEXPR_FUNC simd32_t simd32_x32_ffs(simd32_t _a)
	{
		const simd32_t tz = simd32_x32_cnttz(_a);
		return { 0 == _a.u32 ? 0 : tz.u32 + 1 };
	}

	BX_CONSTEXPR_FUNC simd32_t simd32_x32_part1by1(simd32_t _a)
	{
	...
	BX_CONSTEXPR_FUNC simd32_t simd32_x32_part1by2(simd32_t _a)
	{
	...
	BX_CONSTEXPR_FUNC simd32_t simd32_u32_testpow2(simd32_t _a)
	{
		const uint32_t dec = _a.u32 - 1;
		return { uint32_t(-(int32_t( (_a.u32 ^ dec) >> 1 == dec) ) ) };
	}

	BX_CONSTEXPR_FUNC simd32_t simd32_u32_nextpow2(simd32_t _a)
	{
	...
	BX_CONSTEXPR_FUNC simd32_t simd32_u32_gcd(simd32_t _a, simd32_t _b)
	{
	...
	BX_CONSTEXPR_FUNC simd32_t simd32_u32_lcm(simd32_t _a, simd32_t _b)
	{
	...
	BX_CONSTEXPR_FUNC bool simd32_test_any(simd32_t _test)
	{
		return 0 != _test.u32;
	}

	BX_CONSTEXPR_FUNC bool simd32_test_all(simd32_t _test)
	{
		return 0 != _test.u32;
	}

	BX_CONSTEXPR_FUNC bool simd32_test_zero(simd32_t _a, simd32_t _b)
	{
		return 0 == (_a.u32 & _b.u32);
	}

	BX_CONSTEXPR_FUNC simd32_t simd32_f32_ftoi_trunc(simd32_t _a)
	{
		const simd32_f32_ref_t a      = bitCast<simd32_f32_ref_t>(_a);
	...
	BX_CONSTEXPR_FUNC simd32_t simd32_f32_ftoi_round(simd32_t _a)
	{
		const simd32_f32_ref_t a      = bitCast<simd32_f32_ref_t>(_a);
	...
	BX_CONSTEXPR_FUNC simd32_t simd32_i32_itof(simd32_t _a)
	{
		const simd32_i32_ref_t a      = bitCast<simd32_i32_ref_t>(_a);
